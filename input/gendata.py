...
if True:
    ...
    fixedKz = 'file'
    sourceKz = 'Slope2D002'
    sourceKz = (250, 1e-3, True)  # decay, strength, exponential
    geo_beta = 0.0
    ...
    #print(comments)
    comments = "High Kz=1e-3 250m decay, constant strat, larger horizontal K, Constant slope, no forcing; Constant strat compare with Slope2D021\n"
