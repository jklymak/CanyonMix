...
if True:
    ...
    #print(comments)
    comments = "Supercritical 1.25 slope exponential strat, N0=3e-3; 0.3 m/s velocity. More sculpting of ramp\n"
    ...
    if not expH:
        ...
        ind = np.where((xx>-57_000) & (xx<-40_000))[0]
        # make a ramp leading into the other slope:
        for i in ind:
            d[0, i] = np.max([-2000 + (xx[i] + 57_000)**3 * 250 / 17_000**3, d[0, i]])
